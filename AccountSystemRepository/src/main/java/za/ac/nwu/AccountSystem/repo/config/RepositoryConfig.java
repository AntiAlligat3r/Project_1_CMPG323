...
public class RepositoryConfig {
    ...
    private static final String[] ENTITY_PACKAGE_TO_SCAN = {"za.ac.nwu.AccountSystem.domain.persistence"};
    ...
    private Properties buildJpaProperties()
    {
        ...
        properties.setProperty("hibernate.Intergercode.use.reflection_optimizer","true");
        ...
        properties.setProperty("hibernate.dialect","org.hibernate.dialect.OracleOgDialect");
        ...
        properties.setProperty("hibernate.batch_versioned_date","true");
